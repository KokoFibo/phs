<div>
      ...
      <div class="flex items-center w-3/4 py-3 mx-auto my-2 mb-3 shadow justify-evenly shadow-purple-300 bg-purple-50 rounded-xl">
            ...
            <div class="w-1/4 ">
                  ...
                  <select class="w-full rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500" wire:model="selectedGroup">
            ...
            <div class="w-1/4 ">
                  ...
                  <select class="w-full rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500" wire:model="selectedBranch">
            ...
            <div class="w-1/4 ">
                  ...
                  <select class="w-full rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500" wire:model="selectedKota">
            ...
            <div>
                  <button wire:click="setDefault" class="inline-block px-2 py-1 text-white bg-purple-500 rounded ">Set as Default</button>
            </div>
      </div>
      ...
      <div class="flex justify-center w-3/4 py-5 pb-3 mx-auto my-2 mt-2 mb-5 shadow shadow-purple-300 bg-purple-50 rounded-xl">
            <div class="w-2/5 px-5">
                  ...
                  <div class="mt-3">
                        ...
                        <input id="mandarin" type="text" placeholder="{{ __('中文名') }}" wire:model="mandarin" class="w-full rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500">
                        @error('mandarin')
                        <span class="text-red-500">{{ $message }}</span>
                        @enderror
                  </div>
                  <div class="mt-3">
                        <label class="px-2 " for="tgl_lahir">{{ __('Tanggal Lahir') }}</label><span class="text-red-500">*</span>
                        <input type="date" wire:model="tgl_lahir" class="w-full rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500">
                        @error('tgl_lahir')
                        <span class="text-red-500">{{ $message }}</span>
                        @enderror
                  </div>
                  <div class="mt-3">
                        ...
                        <input id="alamat" type="text" placeholder="{{ __('Alamat Rumah') }}" wire:model="alamat" class="w-full rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500">
                        @error('alamat')
                        <span class="text-red-500">{{ $message }}</span>
                        @enderror
                  </div>
      ...
      <div class="w-2/5 px-5">
            ...
            <div class="mt-5">
                  ...
                  <input id="datepicker" type="date" wire:model="tgl_mohonTao" class="w-full rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500">
                  @error('tgl_mohonTao')
                  <span class="text-red-500">{{ $message }}</span>
                  @enderror
            </div>
