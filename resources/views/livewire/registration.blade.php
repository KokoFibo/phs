                        ...
                        <table class="table w-full mx-auto mt-5">
                              <thead>
                                    <tr class="text-white bg-purple-500 ">
                                          ...
                                          <th class="h-10 text-center border">{{ __('Group') }}</th>
                                    ...
                                    <tr>
                                          ...
                                          <td class="h-10 text-center text-gray-700 border ">
                                                <div class="text-center">
                                                      <button wire:click="edit({{ $d->id }})" class="px-2 py-1 text-sm text-black bg-orange-500 rounded"><i class="fa fa-pen-to-square "></i></button>
