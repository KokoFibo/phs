...
<div class="w-2/3 p-3 mx-auto items-top justify-evenly">
      <div class="">
            <div class="w-full p-4 mt-3 mr-3 text-xl font-semibold text-center text-white bg-teal-500 border shadow-xl rounded-xl">{{ __('Edit Absensi Kelas') }}</div>
            <div class="flex w-full gap-3 mt-3 ">
                  <div class="w-1/3 p-4 text-white bg-teal-500 border shadow-xl rounded-xl">
                        ...
                        <div class="mt-3 ">
                              ...
                              <select class="w-full px-2 py-1 text-purple-700 border border-purple-700 rounded" wire:model="selectedTglEdit">
                        ...
                        <div class="flex justify-between">
                              {{-- <button wire:click="editAbsensiByTgl" class="mt-3 button button-purple"><i class="fa-regular fa-eye"></i>Tampilkan</button> --}}
                              <button wire:click="deleteAbsensiByTglConfirmation" class="mt-3 button button-red"><i class="fa-regular fa-eye"></i>Delete</button>
                                    ...
                                    <tr>
                                          ...
                                          <td class="p-3 text-gray-800 border rounded">
                                                <div class="flex justify-center space-x-1">
                                                      <button type="button" wire:click="hadir({{ $p->id }},1)" class="p-1 text-black bg-blue-500 rounded">
