            ...
            <div class="w-3/4 mx-5 ">
                  <div class="items-center md:flex">
                        ...
                        <div class="w-full mt-3 mr-3 md:w-1/5">
                              <input type="search" class="w-full px-4 py-1 text-purple-700 border border-purple-700 rounded " wire:model="search" placeholder="&#128270 {{ __('Search') }}">
                        </div>
                        {{-- Category --}}
                        <div class="w-full mt-3 mr-3 md:w-1/5">
                        ...
                        <div x-data="{ open: false }" class="w-full mt-3 mr-3 md:w-1/5">
                              <button @click="open = !open" :class="open ? 'bg-purple-500 ' : ''" class="w-full px-2 py-1 text-purple-700 border border-purple-700 rounded hover:bg-purple-700 hover:text-white"><i class="fa fa-filter"></i>
                              ...
                              <div x-show="open" x-cloak @click.away="open = false" x-transition class="min-h-120px mx-auto absolute z-10 px-3 pb-3 rounded-xl w-400px text-purple-700 bg-[#ffffff/.62]  shadow-xl backdrop-blur-sm border border-[#ffffff/.3] ">
                                    ...
                                    <div class="mt-3">
                                          ...
                                          <div class="flex" style="display: flex">
                                                <div>
                                                      <input type="text" class="w-full px-2 py-1 border border-gray-400 rounded" wire:model="startUmur">
                                                </div>
                                                <p class="px-1">-</p>
                                                <div>
                                                      <input type="text" class="w-full px-2 py-1 border border-gray-400 rounded" wire:model="endUmur">
                                                </div>
                                          </div>
                                    </div>
                                    {{-- <div class="block">
                                <div class="mt-2">
                                    ...
                                    <div class="my-3">
                                          ...
                                          <div class="flex" style="display: flex">
                                                <div>
                                                      <input type="date" class="w-full px-2 py-1 border border-gray-400 rounded" wire:model="startDate">
                                                </div>
                                                <div>
                                                      <p class="px-1">-</p>
                                                </div>
                                                <div>
                                                      <input type="date" class="w-full px-2 py-1 border border-gray-400 rounded" wire:model="endDate">
                                                </div>
                                          </div>
                                    </div>
                            ...
                            {{ $d->id }}
                                    ...
                                    <td class="p-3 text-gray-800 border rounded ">
                                          ...
                                          <div class="flex justify-center space-x-1">
                                                ...
                                                <div>
                                                      <a href="/viewdata/{{ $d->id }}"><button type="button" class="p-1 text-black bg-green-400 rounded">
                                                                  <i class="fa fa-eye "></i>
                                                            </button></a>
                                                ...
                                                {{-- <div> --}}
                                                <div>
                                                      <a href="/editdata/{{ $d->id }}"><button type="button" class="p-1 text-black bg-yellow-300 rounded">
                                                ...
                                                <div>
                                                      ...
                                                      <button class="p-1 text-white bg-red-500 rounded" wire:click="deleteConfirmation({{ $d->id }})">
