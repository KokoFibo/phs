      ...
      <div class="flex w-2/3 p-3 mx-auto items-top justify-evenly">
            <div class="w-1/2 p-4 mt-3 mr-3 text-white bg-teal-500 border shadow-xl rounded-xl">
                  ...
                  <div class="w-full mt-3">
                        ...
                        <input id="nama_group" type="text" placeholder="{{ __('Nama Group Vihara') }}" wire:model="nama_group" class="w-full my-3 text-gray-700 rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500">
                        @error('nama_group')
