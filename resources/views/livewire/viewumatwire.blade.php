    ...
    <div
        ...
        <div class="w-2/5 px-5">
            ...
            <div class="mt-3">
                ...
                <input id="email" type="text" wire:model="email"
                    class="w-full mb-5 rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500" disabled>
        ...
        <div class="w-2/5 px-5">
            <div class="mt-3">
                ...
                <input id="alamat" type="text" value="{{ $gender }}"
                    class="w-full rounded-lg shadow-sm focus:border-purple-500 focus:ring-purple-500" disabled>
            ...
            <div class="flex items-center  w-full mt-9 justify-between">
