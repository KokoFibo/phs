...
<div class="flex justify-between items-center mt-5">
      ...
      <h2 class="text-2xl font-semibold text-teal-500 text-center px-3">Group : {{ getGroupVihara($selectedGroup) }}</h2>
      <h2 class="text-3xl font-semibold text-teal-500 text-center">Absensi</h2>
      <h2 class="text-2xl font-semibold text-teal-500 text-center px-3">Kelas : {{ getDaftarKelas($daftarkelas_id)  }}</h2>
</div>
<table table class="w-full mt-1">
      <thead class="text-white bg-teal-500 border-b-2 border-gray-200">
            ...
            <tr>
                  ...
                  <th class="p-3 font-semibold text-center border rounded ">{{ \Carbon\Carbon::parse($h->tgl_kelas)->format('d-m')}}</th>
                  @endforeach
      ...
      <tbody>
            ...
            <tr>
                  ...
                  @php
                  for($i = 0; $i < $jumlahdaftarkelas; $i++){ $hasil=\App\Models\Absensi::query() ->where('daftarkelas_id', $daftarkelas_id)
