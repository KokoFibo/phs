    ...
    <div class="col-6 mt-3 mx-auto">
        <form wire:submit.prevent="store">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_umat') is-invalid @enderror" id="nama"
                    placeholder="Nama Lengkap" wire:model="nama_umat">
                @error('nama_umat')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('mandarin') is-invalid @enderror" id="mandarin"
                    placeholder="中文名" wire:model="mandarin">
                @error('mandarin')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-check d-flex">
                    ...
                    <div class="col-md-2">
                        <input class="form-check-input" type="radio" name="exampleRadios" wire:model="jenis_kelamin"
                            id="jenis_kelamin" value="2" checked>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control @error('tgl_mohonTao') is-invalid @enderror" id="tgl_mohonTao"
                    wire:model="tgl_mohonTao">
                @error('tgl_mohonTao')
                    <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="form-group ">
                ...
                {{-- <select id="branch" class="form-control" wire:model="pengajak">
                    ...
                    @foreach ($datapelita as $pengajak)
            ...
            <div class="form-group ">
                ...
                <input type="text" class="form-control" wire:model="penjamin">
