@if (Auth::user()->role != '0')
    <div>
        <div class="flex flex-wrap items-center justify-between w-full px-4 py-3 text-lg text-white bg-pink-500 lg:py-0">
                                ...
                                <div x-show="open" x-cloak @click.away="open = false" x-transition
                                    ...
                                    <ul class="mx-5 divide-y w-44">
                                        ...
                                        <li
                                            ...
                                            <a class="block"
                                                href="{{ route('branchwire') }}">{{ __('Tambah Data Vihara') }}</a>
                                        </li>
