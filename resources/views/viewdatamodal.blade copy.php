...
<!-- Main modal -->
<div wire:ignore id="defaultModal" x-show="open"
    class="bg-black/50 fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
    {{-- <div class="relative w-full h-full max-w-2xl "> --}}
    <div class="relative w-full h-full md:w-3/4 ">
            ...
            <div
                ...
                <div class="w-full px-5 md:w-1/2 dark:bg-gray-800 dark:border-gray-700 dark:text-black ">
                    ...
                    <div class="flex items-center justify-between w-full mt-9">
                        ...
                        @endif
                        <div>
                            <button type="button" class="button button-black dark:bg-purple-500"
                                data-modal-hide="defaultModal"><i class="fa fa-circle-arrow-left"></i>
                                {{ __('Back') }}</button>
                        </div>
                    </div>
                </div>
