    ...
    @if ($paginator->hasPages())
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                <div>
                    <p class="font-semibold leading-5 text-blue-500 ">
                        <span>{!! __('Total ') !!}</span>
                                    ...
                                    <span
                                        ...
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span
                                                    class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-white bg-gray-500 border border-gray-300 cursor-default select-none">{{ $page }}</span>
                                            </span>
                                        @else
                                            <button
